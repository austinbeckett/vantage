...
// Chart colors
const chartColors = {
  approvals: '#10b981', // secondary-500
  submissions: '#f59e0b', // primary-500
}
...
export function TrendAnalysis({
  ...
  // Find max for therapeutic area chart
    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="p-6 rounded-2xl bg-white dark:bg-neutral-800  border border-neutral-200 dark:border-neutral-700">
        ...
        <div className="space-y-4">
          {therapeuticAreaData.map((item, areaIndex) => {
