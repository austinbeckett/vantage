        ...
        <div className="border-t border-neutral-200 dark:border-neutral-700 p-5 space-y-5 animate-in slide-in-from-top-2 fade-in duration-200">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                ...
                {relatedProducts.length > 3 && (
                  <span className="text-xs px-2.5 py-1 rounded-full bg-neutral-100 dark:bg-neutral-800 text-neutral-500 dark:text-neutral-400">
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-neutral-100 dark:bg-neutral-800 hover:bg-neutral-200 dark:hover:bg-neutral-700 text-neutral-700 dark:text-neutral-300 font-medium transition-colors"
            >
