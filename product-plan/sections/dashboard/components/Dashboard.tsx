...
import {
  ...
  Filter, Clock, Check, CheckCheck, X, Plus, Share2, Download,
  ChevronDown, Calendar, AlertCircle
} from 'lucide-react'
import type {
  DashboardProps,
  ActivityItem,
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          {/* Filters Panel */}
          {showFilters && (
            <div className="p-4 bg-white dark:bg-neutral-800  border border-neutral-200 dark:border-neutral-700 rounded-xl space-y-3 animate-in slide-in-from-top-2 fade-in duration-200">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-2 py-1.5 bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded text-xs text-neutral-700 dark:text-neutral-300"
                  >
                        ...
                        <div className="flex items-center gap-2 mt-3 opacity-0 group-hover:opacity-100 transition-opacity">
                          {!item.isRead && (
                            <button
                              ...
                              className="flex items-center gap-1 px-2 py-1 rounded text-xs text-neutral-600 dark:text-neutral-400 hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors"
                            >
