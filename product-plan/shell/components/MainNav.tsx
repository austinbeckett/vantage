          ...
          return (
            <button
              ...
              className={`
                ...
                ${
                  item.isActive
                    ? 'bg-gradient-to-r from-primary-400/20 to-primary-500/20 text-primary-700 dark:text-primary-400 shadow-sm'
                    : 'text-neutral-600 dark:text-neutral-400 hover:bg-neutral-100/50 dark:hover:bg-neutral-800/50 hover:text-neutral-900 dark:hover:text-neutral-100'
                }
              `}
            >
