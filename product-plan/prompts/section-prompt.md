...
- **SECTION_NAME** = [Human-readable name, e.g., "Dashboard" or "Competitive Intelligence"]
- **SECTION_ID** = [Folder name in sections/, e.g., "dashboard" or "competitive-intelligence"]
- **NN** = [Milestone number, e.g., "02" for Dashboard, "03" for Search & Discovery]

**Section Quick Reference:**
| NN | SECTION_ID | SECTION_NAME |
|----|------------|--------------|
| 02 | dashboard | Dashboard |
| 03 | search-and-discovery | Search & Discovery |
| 04 | watchlists | Watchlists |
| 05 | competitive-intelligence | Competitive Intelligence |
