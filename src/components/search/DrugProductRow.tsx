  ...
  return (
    <div
      className={`
        ...
        ${isExpanded ? 'bg-neutral-50 dark:bg-neutral-750 shadow-sm' : ''}
      `}
    >
      {/* Main row content */}
      <div
      ...
      {isExpanded && (
        <div className="px-5 pb-5 animate-in slide-in-from-top-2 fade-in duration-200">
          <div className="p-5 rounded-xl bg-neutral-100 dark:bg-neutral-700/50 space-y-5">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {relatedProducts.slice(0, 5).map(related => (
                    <span
                      key={related.id}
                      className="text-xs px-2.5 py-1 rounded-full bg-white dark:bg-neutral-800 text-neutral-600 dark:text-neutral-400 border border-neutral-200 dark:border-neutral-600"
                    >
                      {related.productName}
                    </span>
                  ))}
                  {relatedProducts.length > 5 && (
                    <span className="text-xs px-2.5 py-1 rounded-full bg-neutral-200 dark:bg-neutral-600 text-neutral-500 dark:text-neutral-400">
            ...
            <div className="flex gap-3 pt-2">
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-white dark:bg-neutral-800 hover:bg-neutral-50 dark:hover:bg-neutral-700 text-neutral-700 dark:text-neutral-300 font-medium border border-neutral-200 dark:border-neutral-600 transition-colors"
              >
