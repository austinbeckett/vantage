...
import type { SearchAndDiscoveryProps, ActiveFilter } from '../../types/search'
    ...
    <div className="space-y-6">
      ...
      {filteredProducts.length === 0 ? (
        ...
        <div className="bg-white dark:bg-neutral-800 rounded-2xl border border-neutral-200 dark:border-neutral-700 overflow-hidden">
          {/* Table header */}
          <div className="grid grid-cols-[1fr,140px,140px,100px,100px,100px,44px] gap-4 px-5 py-3 bg-neutral-100 dark:bg-neutral-700/50 border-b border-neutral-200 dark:border-neutral-700 text-xs uppercase tracking-wider text-neutral-500 dark:text-neutral-400 font-medium">
            <div>Product</div>
            <div>Ingredient</div>
