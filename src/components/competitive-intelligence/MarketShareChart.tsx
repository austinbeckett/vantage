import type { MarketShareItem } from '../../types/competitive-intelligence'
...
const segmentColors = [
  { bg: 'bg-primary-500', stroke: '#de7356' },
  { bg: 'bg-secondary-500', stroke: '#6b8455' },
  { bg: 'bg-orange-400', stroke: '#fb923c' },
  { bg: 'bg-teal-500', stroke: '#14b8a6' },
  { bg: 'bg-primary-300', stroke: '#f6b5a3' },
  { bg: 'bg-lime-500', stroke: '#84cc16' },
  { bg: 'bg-neutral-400', stroke: '#b8b3a4' },
  { bg: 'bg-neutral-300', stroke: '#e2dfd4' },
]
